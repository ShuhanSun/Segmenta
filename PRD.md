...
- 产品方向与需求决策：Shuhan Sun，仓库所有者及功能决策人
- 技术整理：Codex，根据真人反馈和当前代码实现整理
- 文档状态：Human-directed, AI-assisted（真人主导、AI 辅助），不是独立真人撰写
- 对应版本：`v0.1.0` 及其后的产品定位补充

真人原始回答保存在 `docs/HUMAN_PRODUCT_DECISIONS.md`，没有在该文件中润色或覆盖。
...
当前版本只实现精确字段过滤。真人需求中提出的“按照主题、项目，支持模糊的语言描述”计划采用离线混合搜索，不依赖外部大模型、账号或随包模型权重，但这部分尚未实现。
...
这些是经过真人确认的产品方向，但不属于当前版本已经完成的核心功能：
